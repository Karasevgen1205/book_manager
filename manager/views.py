...
class MyPage(View):
    def get(self, request):
        ...
        paginator = Paginator(books.order_by("-rate", "date"), 5)    # CREATE PAGINATOR
        context['books'] = paginator.get_page(request.GET.get("page", 1))     # CREATE PAGINATOR
...
class CustomUserCreationForm(object):
    pass
